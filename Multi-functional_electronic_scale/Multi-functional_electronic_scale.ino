...
dht11 DHT11;
#define DHT11PIN 2
float temperature,humidity,needed;
//电子秤
#include "HX711.h"
float Weight = 0;
...
void loop() {
  // put your main code here, to run repeatedly:
    ...
    needed=DHT11.waterNeeded((float)DHT11.temperature,(float)DHT11.humidity);
    limitAndJudge();
